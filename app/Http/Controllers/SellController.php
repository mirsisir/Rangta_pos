    ...
    public function index()
    {
        ...
        if (request()->ajax()) {
            ...
            if(!empty($imei_number)){
                $imei_info = Imei::where('imei1','=',$imei_number)->orwhere('imei2','=',$imei_number)->first();
                $imei_id = $imei_info->id ?? null;
            }
            ...
            $sells = $this->transactionUtil->getListSells($business_id, $sale_type,$imei_id);
