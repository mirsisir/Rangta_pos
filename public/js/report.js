    ...
    product_purchase_report = $('table#product_purchase_report_table').DataTable({
        ...
        ajax: {
            ...
            data: function(d) {
                ...
                if(typeof $('#imei_id_value').val() != 'undefined' && $('#imei_id_value').val()!=''){
                    d.imei_id_value = $('#imei_id_value').val();
                }
        ...
        $('#search_product').autocomplete({
            source: function(request, response) {
                $.ajax({
                    ...
                    success: function(data) {
                        if(typeof data[0].imei_id !='undefined' && data[0].imei_id!=''){
                            $('#imei_id_value').val(data[0].imei_id);
                        }else{
                            $('#imei_id_value').val('');
                        }
                        response(
