        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                <div class="form-group">
                    <br>
                    @if($imei)
                        <input type="hidden" name="is_accessories" value="{{$product->is_accessories}}">
                        <label>
                            {{--{!! Form::checkbox('is_accessories', 1, !empty($product) ? $product->is_accessories : true, ['class' => 'input-icheck', 'id' => 'is_accessories', 'disabled' => "disabled"]); !!} <strong>@lang('product.is_accessories')</strong>--}}
                            {!! Form::checkbox('is_accessories', 1, !empty($product) ? 1 : true, ['class' => 'input-icheck', 'id' => 'is_accessories', 'disabled' => "disabled"]); !!} <strong>Has IMEI or Serial Number</strong>
                        </label>
                    @else
                        <label>
                            {!! Form::checkbox('is_accessories', 1, !empty($product) ? 0 : true, ['class' => 'input-icheck', 'id' => 'is_accessories']); !!} <strong>{{--@lang('product.is_accessories')--}} Has IMEI or Serial Number</strong>
                        </label>
                    @endif
                </div>
            </div>
