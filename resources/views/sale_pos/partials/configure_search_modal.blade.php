			...
			<div class="modal-body">
				<div class="row">
					...
					<div class="col-md-6">
						<div class="checkbox">
							<label>
				              	{!! Form::checkbox('search_fields[]', 'sku', true, ['class' => 'input-icheck search_fields']); !!} @lang('purchase.sku')
				            </label>
						</div>
					</div>
					<div class="col-md-6">
						<div class="checkbox">
							<label>
								{!! Form::checkbox('search_fields[]', 'imei', true, ['class' => 'input-icheck search_fields']); !!} IMEI/Serial Number
							</label>
						</div>
					</div>
