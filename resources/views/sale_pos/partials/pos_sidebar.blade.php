...
<div class="row">
	...
	<!-- modified by nirjar -->
	<div class="col-md-3" id="product_service_div">
		{!! Form::select('is_enabled_stock', ['product' => 'Current Product', 'all' => __('messages.all'),], null, ['id' => 'is_enabled_stock', 'class' => 'select2', 'name' => null, 'style' => 'width:100% !important']) !!}
