	...
	@component('components.widget', ['class' => 'box-primary'])
		<div class="row">
			...
			<div class="col-sm-2" style="margin-top: 7px;">
				<a href="{{url('products/create')}}" target="_blank"><i class="fa fa-plus"></i> @lang( 'product.add_new_product' ) </a>
				</div>
{{--				<div class="form-group">--}}
...
{{--				</div>--}}
	...
	@component('components.widget', ['class' => 'box-primary', 'title' => __('Supply Payment')])
