			...
			<div style="overflow: hidden !important;display: flex; flex-wrap: wrap;align-content: center;width: {{$barcode_details->width * 1}}in; height: {{$barcode_details->height * 1}}in;">
				...
				<div>
					...
					@if(!empty($print['business_name']))
						<b style="display: block !important; font-size: {{10*$factor}}px">{{$business_name}}</b>
					@endif
					...
					@if(!empty($print['product_custom_field1']))
						<small style="display: block !important; font-size: {{20*$factor}}px">{{$page_product->product_custom_field1}}</small>
					@endif
